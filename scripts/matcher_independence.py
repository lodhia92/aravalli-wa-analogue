...
# 100 000 permutations and seed 20260827, matching scripts/fingerprint_transfer.py, so that
# the SIX (original) baseline in this table is the same number the paper reports.
NPERM = 100000
...
# original robust-20, used to measure pair-set overlap
