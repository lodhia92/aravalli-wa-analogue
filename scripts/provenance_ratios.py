...
# --- India: NGCM geochemistry joined to drainage selection ---
...
# --- Australia: NGSA ICP-MS geochem joined to drainage selection by SITEID ---
...
# save the joined ratio data for plotting
allr = []
for nm, df in sets.items():
