...
# ---- Australia (NGSA; corrected sorted-index loader, see section 5d of the log) ----
NG = paths.NGSA
...
# ---- within-survey standardisation (same pools as pair_validation.py) ----
def zscore(pool):
...
# ---- verification against pair_validation.py (per-mineral rho, robust-20 pairs) ----
